	    ...
	    <div class="card">
	      <div class="card-header row">
	      	...
	      	<div class="col-sm-6" align="right">      
	            ...
	            <a href="index.php?user=admin&action=agregar_alumno&id_grupo=<?php echo $_GET['id_grupo']?>" class="btn btn-success">Dar de alta Alumno</a>
	        	<?php } ?>
	            <a href="index.php?user=<?php echo $_GET['user']?>&action=unidades&id_grupo=<?php echo $_GET['id_grupo']?>" class="btn btn-info">Ver Unidades</a>           
	      	</div>
