...
!function($) {
    ...
    Dashboard.prototype.init = function() {
        ...
        var $stckedData2  = [
            { y: 'Junio', a: <?php echo $jun2; ?> },
            { y: 'Julio', a: <?php echo $jul2; ?> },
            { y: 'Agosto', a: <?php echo $ago2; ?> },
            { y: 'Septiembre', a: <?php echo $sep2; ?> },
            { y: 'Octubre', a: <?php echo $oct2; ?> },
            { y: 'Noviembre', a: <?php echo $nov2; ?> },
        ];
        this.createStackedChart('ingresos-mes', $stckedData2, 'y', ['a'], ['Ingresos'], ['#9F2C2C']);
