<?php
  ...
  $ventasHoy = current($conexion->query("SELECT count(*) from venta where DAY(fecha)= $fecha")->fetch_assoc());
  $ingresosHoy = current($conexion->query("SELECT SUM(total) from venta where DAY(fecha)= $fecha")->fetch_assoc());

  //devuelve el numero de ventas totales
  ...
  $reporte = $conexion->query("SELECT * from venta");
...
<html lang="en">
                ...
                <div id="page-right-content">
                    <div class="container">
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="widget-inline-box text-center">
                              ...
                              ?>
                              <h2><?php echo "Fecha Actual: ".$numDia." - ".$mes." - 20".$anio; ?></h2><br>
                            </div>                            
                          </div>
                        ...
                        <div class="row">
                              ...
                              <h4 class="m-t-0 text-dark">Ventas de Hoy</h4>
                              <h2 class="text-pink text-center m-b-30 m-t-30"><span data-plugin="counterup"><?php echo $ventasHoy; ?></span></h2>
                              <p class="m-b-0 text-muted">Total de ventas: <?php echo $numVentas; ?> <span class="pull-right"><i class="fa fa-caret-down text-danger m-r-5"></i>7.85%</span></p>
                            </div>
            							</div>
                          <div class="col-sm-6">
                            <div class="card-box">
                              <i class="fa fa-info-circle text-muted pull-right inform" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="Tooltip on right"></i>
                              <h4 class="m-t-0 text-dark">Ingresos de Hoy</h4>
                              <h2 class="text-primary text-center m-b-30 m-t-30">$<span data-plugin="counterup"><?php echo $ingresosHoy; ?></span></h2>
                              <p class="text-muted m-b-0">Ingresos totales: $<?php echo $ingresosTotales; ?> <span class="pull-right"><i class="fa fa-caret-up text-primary m-r-5"></i>10.25%</span></p>
                            </div>
                          </div>
            						</div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Ventas por Empleado</h4>                                    
                                    <div id="ventas-empleado" style="height: 300px;"></div>
                                </div>
                            </div> <!-- end col -->
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="card-box">
                                    <h4 class="m-t-0">Ventas por Categoria</h4>                                    
                                    <div id="ventas-categoria" style="height: 300px;"></div>
                                </div>
                            </div> <!-- end col -->
                        </div>
    ...
    <script src="assets/pages/jquery.dashboard.js"></script>
        ...
        <?php //include("graficas.php"); 
              include("grafica_ventas_empledo.php");
              include("grafica_ventas_categoria.php"); ?>
