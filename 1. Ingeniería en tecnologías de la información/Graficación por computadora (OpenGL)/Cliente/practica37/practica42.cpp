...
void DibujaCilindro(int X, int Y, int Z, float rad1, float rad2, int anchura,  GLfloat LADOS, float colores[]) {
...
void Display(void) {
    ...
    for (int i = 0; i < 2; i++){
        ...
        glRotatef(90, 1, 0, 0);
        DibujaCilindro(0, 0, 0, 15, 8, 5, 6, colores);
        glPopMatrix();

        glPushMatrix();
        glTranslatef(0,alt-13,0);
        glRotatef(90, 1, 0, 0);
        DibujaCilindro(0, 0, 0, 8, 15, 5, 6, colores);
        glPopMatrix();
        ...
        glRotatef(90, 1, 0, 0);
        DibujaCilindro(0, 0, 0, 15, 15, 8, 6, colores);
        glPopMatrix();
    }
    ...
    glTranslatef(0,44,0);
    glRotatef(90, 1, 0, 0);
    DibujaCilindro(0, 0, 0, 6, 6, 3, 6, colores);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(0,18, 0);
    glRotatef(90, 1, 0, 0);
    DibujaCilindro(0, 0, 0, 5, 5, 16, 6, colores);
    glPopMatrix();
    ...
    glTranslatef(0,34,0);
    glRotatef(90, 1, 0, 0);
    DibujaCilindro(0, 0, 0, 5, 3, 10, 6, colores);
    glPopMatrix();

    glPushMatrix();
    glTranslatef(0,8,0);
    glRotatef(90, 1, 0, 0);
    DibujaCilindro(0, 0, 0, 3, 5, 10, 6, colores);
    glPopMatrix();
}
...
int main(int argc, char *argv[])
{
    ...
    glutCreateWindow(" Practica 04_ Mancuerna");
    init(); 
