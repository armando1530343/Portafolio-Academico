<?php
    ...
    $consultaProductos = $conexion->query("SELECT * FROM inventario");   
                              ...
                              <div class="card-box">
                                  ...
                                  <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php while($con = $consultaProductos->fetch_assoc()){ 
                                          $categoria = $conexion->query("SELECT nombre from categoria where id = ".$con['id_categoria'])->fetch_assoc();
                                          $proveedor = $conexion->query("SELECT nombre from proveedor where id = ".$con['id_proveedor'])->fetch_assoc();

                                        ?>
                                        <tr>
                                          <td><?php echo $con['id_producto']; ?></td>
                                          <td><?php echo $con['nombre']; ?></td>
                                          <td><?php echo $con['descripcion']; ?></td>
                                          <td><?php echo $con['cantidad']; ?></td>
                                          <td><?php echo $categoria['nombre']; ?></td>
                                          <td><?php echo $con['compra']; ?></td>
                                          <td><?php echo $con['venta']; ?></td>
