<?php
    ...
    $empleadoss = $conexion->query("SELECT * from empleado");
                ...
                <div id="page-right-content">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                          <div class="col-lg-12">
                              <div class="card-box">
                                <h2 style="color: red">Lista de Empleados</h2><br>
                                <div class="table-responsive m-b-20">
                                    <table id="datatable" class="table table-striped table-bordered">
                                        ...
                                        <tr>
                                          ...
                                          <td><?php echo $con['apellidos']; ?></td>
                                          <td><?php echo $con['edad']; ?></td>
                                          <td><?php echo $con['domicilio']; ?></td>
                                          <td><?php echo $con['usuario']; ?></td>
                                          <td><?php echo $con['clave']; ?></td>
                                        </tr>
                                        <?php } ?>
