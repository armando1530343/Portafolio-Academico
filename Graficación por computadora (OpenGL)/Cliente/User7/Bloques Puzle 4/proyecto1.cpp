...
string label_nivel[6] = {"Nivel 1", "Nivel 2", "Nivel 3", "Nivel 4", "Nivel 5", "Nivel 6"};
...
void display(void)
{
    ...
    if(end_game == false){
        ...
        glColor3f(1,1,1);
        glRasterPos2f(500, 550);
        writeBitmapString(GLUT_BITMAP_HELVETICA_18, label_nivel[numero_nivel]);
...
int main(int argc, char *argv[])
{
    ...
    // DECLARACION DE VARIABLES DEL NIVEL 4


    niveles[3].nivel = Mapa("Level-Maps/nivel4/nivel4.txt");
    niveles[3].coords_mapa = niveles[3].nivel.generar_coords_mapa();
    
    _pieza.mapa = niveles[3].nivel.mapa_bits_pieza("Level-Maps/nivel4/pieza1.txt");
    _pieza.posiciones = niveles[3].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 1;
    niveles[3].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[3].nivel.mapa_bits_pieza("Level-Maps/nivel4/pieza2.txt");
    _pieza.posiciones = niveles[3].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 2;
    niveles[3].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[3].nivel.mapa_bits_pieza("Level-Maps/nivel4/pieza3.txt");
    _pieza.posiciones = niveles[3].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 3;
    niveles[3].datos_pieza.push_back(_pieza);
    niveles[3].numero_piezas = niveles[3].datos_pieza.size();

    // DECLARACION DE VARIABLES DEL NIVEL 5


    niveles[4].nivel = Mapa("Level-Maps/nivel5/nivel5.txt");
    niveles[4].coords_mapa = niveles[4].nivel.generar_coords_mapa();
    
    _pieza.mapa = niveles[4].nivel.mapa_bits_pieza("Level-Maps/nivel5/pieza4.txt");
    _pieza.posiciones = niveles[4].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 4;
    niveles[4].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[4].nivel.mapa_bits_pieza("Level-Maps/nivel5/pieza1.txt");
    _pieza.posiciones = niveles[4].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 1;
    niveles[4].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[4].nivel.mapa_bits_pieza("Level-Maps/nivel5/pieza3.txt");
    _pieza.posiciones = niveles[4].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 3;
    niveles[4].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[4].nivel.mapa_bits_pieza("Level-Maps/nivel5/pieza2.txt");
    _pieza.posiciones = niveles[4].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 2;
    niveles[4].datos_pieza.push_back(_pieza);
    niveles[4].numero_piezas = niveles[4].datos_pieza.size();

    // DECLARACION DE VARIABLES DEL NIVEL 6


    niveles[5].nivel = Mapa("Level-Maps/nivel6/nivel6.txt");
    niveles[5].coords_mapa = niveles[5].nivel.generar_coords_mapa();
    
    _pieza.mapa = niveles[5].nivel.mapa_bits_pieza("Level-Maps/nivel6/pieza2.txt");
    _pieza.posiciones = niveles[5].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 2;
    niveles[5].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[5].nivel.mapa_bits_pieza("Level-Maps/nivel6/pieza4.txt");
    _pieza.posiciones = niveles[5].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 4;
    niveles[5].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[5].nivel.mapa_bits_pieza("Level-Maps/nivel6/pieza3.txt");
    _pieza.posiciones = niveles[5].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 3;
    niveles[5].datos_pieza.push_back(_pieza);

    _pieza.mapa = niveles[5].nivel.mapa_bits_pieza("Level-Maps/nivel6/pieza1.txt");
    _pieza.posiciones = niveles[5].nivel.coords_mapa_bits_pieza();
    _pieza.num_pieza = 1;
    niveles[5].datos_pieza.push_back(_pieza);
    niveles[5].numero_piezas = niveles[5].datos_pieza.size();
