...
GLfloat ballRadius2 = 0.2f;   // Radius of the bouncing ball
GLfloat ballX2 = 0.0f;         // Ball's center (x, y) position
GLfloat ballY2 = 0.0f;
GLfloat ballXMax2, ballXMin2, ballYMax2, ballYMin2; // Ball's center (x, y) bounds
GLfloat xSpeed2 = 0.03f;      // Ball's speed in x and y directions
GLfloat ySpeed2 = 0.005f;
